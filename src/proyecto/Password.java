...
public class Password extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        char[] caracteres = jPasswordField1.getPassword();
        String password = new String(caracteres);//dado ke jpassword devuelve una cadena de caractres y los pasamos a String con este objeto

        boolean seguir = Variables.BD.existeUsuarioPassword(usuario, password);

        if (seguir) {

            Principal principal = new Principal();
            principal.setLocationRelativeTo(null); //centra ventana
             this.dispose();//cierra la venta y libera de memoria
             principal.setVisible(true);
            
        }//end del if
        else {
            JOptionPane.showMessageDialog(this, "ID incorrecto o contraseña no válida");
            jTextField1.setText("");
            //char[] ch = {};
            //jPasswordField1.
